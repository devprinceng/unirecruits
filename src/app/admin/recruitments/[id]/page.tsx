...
import { fetchRecruitmentApplications, fetchRecruitmentById, updateApplicationStatus } from '@/lib/api';
  ...
  useEffect(() => {
    async function loadRecruitment() {
      try {
        ...
        const applications = await fetchRecruitmentApplications(id);

        // ✅ Safe parse requirements if string
        if (typeof recruitment.requirements === "string") {
          try {
            recruitment.requirements = JSON.parse(recruitment.requirements);
          } catch {
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
                  {Array.isArray(recruitment.requirements) ? (
                    ...
                    <li>{String(recruitment.requirements)}</li>
                  )}
                </ul>
              </div>
